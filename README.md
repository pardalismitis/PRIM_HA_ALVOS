...
Estruturação automatizada dos **alvos de conservação** presentes no Plano de Redução de Impactos de Hidrelétricas sobre a Biodiversidade na Amazônia - PRIM-HA.

Este repositório contém um pipeline em R desenvolvido para extrair, padronizar e organizar os alvos de conservação (Fauna, Flora, Fitofisionomias e Ambientes Singulares) a partir dos arquivos brutos disponíveis no Material Suplementar do PRIM HA, transformando o conteúdo textual em uma base de dados estruturada.
